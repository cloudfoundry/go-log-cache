...
func (EnvelopeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_egress_cf7ab153bf296ba6, []int{0}
}
...
func (*ReadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_egress_cf7ab153bf296ba6, []int{1}
}
...
func (*MetaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_egress_cf7ab153bf296ba6, []int{2}
}
...
func (*MetaResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_egress_cf7ab153bf296ba6, []int{3}
}
...
func (*MetaInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_egress_cf7ab153bf296ba6, []int{4}
}
...
func init() { proto.RegisterFile("egress.proto", fileDescriptor_egress_cf7ab153bf296ba6) }

var fileDescriptor_egress_cf7ab153bf296ba6 = []byte{
