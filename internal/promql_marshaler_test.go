...
var _ = Describe("PromqlMarshaler", func() {
	...
	Context("Unmarshal()", func() {
		FIt("unmarshals a scalar instant query result", func() {
			marshaler := internal.NewPromqlMarshaler(&mockMarshaler{})
		...
		FIt("marshals a vector instant query result", func() {
			marshaler := internal.NewPromqlMarshaler(&mockMarshaler{})
		...
		FIt("marshals a matrix instant query result", func() {
			marshaler := internal.NewPromqlMarshaler(&mockMarshaler{})
		...
		FIt("marshals a matrix range query result", func() {
			marshaler := internal.NewPromqlMarshaler(&mockMarshaler{})
